...
function copyObjectDeep(o) {
    var result = {};
    if (typeof o === "object" && o !== null)
      for (i in o) result[i] = copyObjectDeep(o[i]);
    else result = o;
    return result;
  }
...
const student = {
  ...
  const deepCopy = copyObjectDeep(student);
  ...
  console.log("2. 원본 객체의 address와 얕은 복사 객체의 address가 같을까요?", shallowCopy.address === student.address);
