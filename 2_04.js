...
var newArr = student.sort((a, b) => b.age - a.age);
console.log(newArr);
...
var result = student.some(x => x.name === null);
console.log(result);

9.
var arr = ["banana", "kiwi", "mango", "strawberry", "lime", "orange", "plum", "cherry"];
// 문자열 길이가 5를 초과하는 요소가 있는지 검사하는 코드를 작성하고 반환값을 출력해주세요.
var result = arr.some(x => x.length > 5);
console.log(result);
...
var result = arr.some(x => x < 0);
console.log(result);

12.
var arr = [1, 5, -3, 10, 0, 8];
// 모든 숫자가 음수인지 판별하는 코드를 작성하고 반환값을 출력해주세요
var result = arr.every(x => x < 0);
console.log(result);